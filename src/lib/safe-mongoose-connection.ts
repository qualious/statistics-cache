...
interface SafeMongooseConnectionOptions extends ConnectionOptions {
  mongoUrl: string;
  retryDelayMs?: number;
  debugCallback?: (
...
const defaultMongooseConnectionOptions: ConnectionOptions = {
  useFindAndModify: false, // To be able to use findOneAndUpdate()
...
export default class SafeMongooseConnection {
  ...
  private options: SafeMongooseConnectionOptions;
